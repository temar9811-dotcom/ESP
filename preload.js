...
contextBridge.exposeInMainWorld('eveApi', {
  ...
  getSkillMeta: invoke('skills:getMeta'),
  resolveNames: invoke('skills:resolveNames'),
  getCharacterSkills: invoke('skills:getCharacter'),
  getCharacterWallet: invoke('wallet:getCharacter'),
  getCloneDetails: invoke('accounts:getCloneDetails'),
  getCloneNickname: invoke('cloneNicknames:get'),
  setCloneNickname: invoke('cloneNicknames:set'),
  getAllCloneNicknames: invoke('cloneNicknames:getAll'),
  getPersonalAssets: invoke('assets:getPersonal'),
  getCorpAssets: invoke('assets:getCorp'),
  refreshAssetsNow: invoke('assets:refreshNow'),
  getAssetsQueueState: invoke('assets:getQueueState'),
  getRawAssets: invoke('assets:getRaw'),
  getCorpRawAssets: invoke('assets:getCorpRaw'),
  queueAssetsRefresh: invoke('assets:queueRefresh'),
  getAssetNames: invoke('assets:getNames'),
  ...
  importLegacy: invoke('import:legacy'),
