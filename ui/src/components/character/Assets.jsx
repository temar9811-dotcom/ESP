// File: ui/src/components/character/Assets.jsx | Version: 1.1
import React, { useState, useEffect } from 'react';

export default function Assets({ characterId }) {
  ...
  useEffect(() => {
    ...
    const fetchAssets = async () => {
      ...
      try {
        const data = isCorp 
          ? await window.eveApi.getCorpAssets(characterId)
          : await window.eveApi.getPersonalAssets(characterId);
